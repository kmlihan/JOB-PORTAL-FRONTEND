...
export function deleteCompany(http: HttpClient, rootUrl: string, params: DeleteCompany$Params, context?: HttpContext): Observable<StrictHttpResponse<SimpleStatusDto>> {
...
deleteCompany.PATH = '/api/companies/{id}';
